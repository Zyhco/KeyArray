// KeyArray Demonstration
// Author: Eli (Eliyahu) Shif
// Description: This file demonstrates the usage of KeyArray with fixed size,
// dynamic resizing, and optional overflow queue.
...
int main() {
    ...
    std::cout << "\nEXPECTED OUTPUT: Inserted keys: 0, 1, 2\n";
    std::cout << "Inserted keys: " << k1 << ", " << k2 << ", " << k3 << "\n";

    std::cout << "\nEXPECTED OUTPUT: Size after insert: 3\n";
    std::cout << "Size after insert: " << arr.size() << "\n";

    std::cout << "\nEXPECTED OUTPUT: At 1: banana\n";
    std::cout << "At 1: " << arr.at(1) << "\n";

    arr.at(1) = "blueberry";
    std::cout << "\nEXPECTED OUTPUT: Modified 1: blueberry\n";
    std::cout << "Modified 1: " << arr.at(1) << "\n";

    std::cout << "\nEXPECTED OUTPUT: HasKey 0? 1\n";
    std::cout << "HasKey 0? " << arr.hasKey(0) << "\n";

    std::cout << "\nEXPECTED OUTPUT: HasKey 99? 0\n";
    std::cout << "HasKey 99? " << arr.hasKey(99) << "\n";

    std::cout << "\nEXPECTED OUTPUT: Contains apple? 1\n";
    std::cout << "Contains apple? " << arr.contains("apple") << "\n";

    arr.swap(0, 2);
    std::cout << "\nEXPECTED OUTPUT: After swap - At 0: cherry, At 2: apple\n";
    std::cout << "At 0: " << arr.at(0) << "\n";
    std::cout << "At 2: " << arr.at(2) << "\n";

    arr.remove(0);
    std::cout << "\nEXPECTED OUTPUT: Size after remove: 2\n";
    ...
    std::cout << "\nEXPECTED OUTPUT: Size after dynamic insert: 150\n";
    ...
    std::cout << "\nEXPECTED OUTPUT: Queue size (overflowed): >0\n";
